...
public class ReLogoTurtle extends BaseTurtle{
	...
	/**
	 * Makes a number of new protoMemes and then executes a set of commands on the
	 * created protoMemes.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<picdna.relogo.ProtoMeme> hatchProtoMemes(int number, Closure closure) {
		AgentSet<picdna.relogo.ProtoMeme> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.hatch(number,closure,"ProtoMeme");
	 ...
	 */
	@ReLogoBuilderGeneratedFor("picdna.relogo.ProtoMeme")
	public AgentSet<picdna.relogo.ProtoMeme> hatchProtoMemes(int number) {
		return hatchProtoMemes(number,null);
	}

	/**
	 * Returns an agentset of protoMemes from the patch of the caller.
	 * 
	 * @return agentset of protoMemes from the caller's patch
	 */
	@ReLogoBuilderGeneratedFor("picdna.relogo.ProtoMeme")
	public AgentSet<picdna.relogo.ProtoMeme> protoMemesHere(){
	  Grid grid = getMyObserver().getGrid();
	  GridPoint gridPoint = grid.getLocation(this);
	  AgentSet<picdna.relogo.ProtoMeme> result = new AgentSet<picdna.relogo.ProtoMeme>();
	  for (Turtle t : Utility.getTurtlesOnGridPoint(gridPoint,getMyObserver(),"protoMeme")){
			if (t instanceof picdna.relogo.ProtoMeme)
			result.add((picdna.relogo.ProtoMeme)t);
		}
		return result;
	...
	/**
	 * Returns the agentset of protoMemes on the patch at the direction (ndx, ndy) from the
	 * caller.
	 * 
	 * @param nX
	 *            a number
	 * @param nY
	 *            a number
	 * @returns agentset of protoMemes at the direction (nX, nY) from the caller
	 */
	@ReLogoBuilderGeneratedFor("picdna.relogo.ProtoMeme")
	public AgentSet<picdna.relogo.ProtoMeme> protoMemesAt(Number nX, Number nY){
	...
	public AgentSet<picdna.relogo.ProtoMeme> protoMemesOn(Patch p){
		AgentSet<picdna.relogo.ProtoMeme> result = new AgentSet<picdna.relogo.ProtoMeme>();						
		for (Turtle t : Utility.getTurtlesOnGridPoint(p.getGridLocation(),getMyObserver(),"protoMeme")){
			if (t instanceof picdna.relogo.ProtoMeme)
			result.add((picdna.relogo.ProtoMeme)t);
		}
		return result;
	...
	public AgentSet<picdna.relogo.ProtoMeme> protoMemesOn(Turtle t){
		AgentSet<picdna.relogo.ProtoMeme> result = new AgentSet<picdna.relogo.ProtoMeme>();						
		for (Turtle tt : Utility.getTurtlesOnGridPoint(Utility.ndPointToGridPoint(t.getTurtleLocation()),getMyObserver(),"protoMeme")){
	...
	public AgentSet<picdna.relogo.ProtoMeme> protoMemes(){
		...
		for (Object e : this.getMyObserver().getContext().getObjects(picdna.relogo.ProtoMeme.class)) {
	...
	public picdna.relogo.UserLink createUserLinkFrom(Turtle t, Closure closure){
		picdna.relogo.UserLink link = (picdna.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(t,this);
		if (closure != null){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("picdna.relogo.UserLink")
	public picdna.relogo.UserLink createUserLinkFrom(Turtle t){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("picdna.relogo.UserLink")
	public AgentSet<picdna.relogo.UserLink> createUserLinksFrom(Collection<? extends Turtle> a, Closure closure){
		AgentSet<picdna.relogo.UserLink> links = new AgentSet<picdna.relogo.UserLink>();
		for(Turtle t : a){
			links.add((picdna.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(t,this));
		}
		if (closure != null){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("picdna.relogo.UserLink")
	public AgentSet<picdna.relogo.UserLink> createUserLinksFrom(Collection<? extends Turtle> a){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("picdna.relogo.UserLink")
	public picdna.relogo.UserLink createUserLinkTo(Turtle t, Closure closure){
		picdna.relogo.UserLink link = (picdna.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(this,t);
		if (closure != null){
			this.ask(link,closure);
		}
		return link;
	 ...
	 */
	@ReLogoBuilderGeneratedFor("picdna.relogo.UserLink")
	public picdna.relogo.UserLink createUserLinkTo(Turtle t){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("picdna.relogo.UserLink")
	public AgentSet<picdna.relogo.UserLink> createUserLinksTo(Collection<? extends Turtle> a, Closure closure){
		AgentSet<picdna.relogo.UserLink> links = new AgentSet<picdna.relogo.UserLink>();
		for(Object t : a){
			if (t instanceof Turtle){
				links.add((picdna.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").addEdge(this,(Turtle)t));
			}
		}
		if (closure != null){
			this.ask(links,closure);
	 ...
	 */
	@ReLogoBuilderGeneratedFor("picdna.relogo.UserLink")
	public AgentSet<picdna.relogo.UserLink> createUserLinksTo(Collection<? extends Turtle> a){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("picdna.relogo.UserLink")
	public picdna.relogo.UserLink inUserLinkFrom(Turtle t){
		return (picdna.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").getEdge(t,this);
	}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("picdna.relogo.UserLink")
	public AgentSet<picdna.relogo.UserLink> myInUserLinks(){
		AgentSet<picdna.relogo.UserLink> result = new AgentSet<picdna.relogo.UserLink>();
		for(Object o :  this.getMyObserver().getNetwork("UserLink").getInEdges(this)){
			if (o instanceof picdna.relogo.UserLink){
				result.add((picdna.relogo.UserLink) o);
			}
		}
		return result;
	}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("picdna.relogo.UserLink")
	public AgentSet<picdna.relogo.UserLink> myOutUserLinks(){
		AgentSet<picdna.relogo.UserLink> result = new AgentSet<picdna.relogo.UserLink>();
	 ...
	 */
	@ReLogoBuilderGeneratedFor("picdna.relogo.UserLink")
	public picdna.relogo.UserLink outUserLinkTo(Turtle t){
		return (picdna.relogo.UserLink)this.getMyObserver().getNetwork("UserLink").getEdge(this, t);
	}
	 ...
	 */
	@ReLogoBuilderGeneratedFor("picdna.relogo.UserLink")
	public AgentSet<picdna.relogo.UserLink> myUserLinks(){
		AgentSet<picdna.relogo.UserLink> result = new AgentSet<picdna.relogo.UserLink>();
	...
	public AgentSet<picdna.relogo.UserLink> userLinks(){
		...
		for (Object e : this.getMyObserver().getContext().getObjects(picdna.relogo.UserLink.class)) {
	...
	public picdna.relogo.UserLink userLink(Number oneEnd, Number otherEnd) {
		return (picdna.relogo.UserLink)(this.getMyObserver().getNetwork("UserLink").getEdge(turtle(oneEnd),turtle(otherEnd)));
	}
