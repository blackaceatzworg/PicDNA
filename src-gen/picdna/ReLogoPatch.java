...
public class ReLogoPatch extends BasePatch{
	...
	/**
	 * Sprouts (makes) a number of new protoMemes and then executes a set of commands on the
	 * created protoMemes.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<picdna.relogo.ProtoMeme> sproutProtoMemes(int number, Closure closure) {
		AgentSet<picdna.relogo.ProtoMeme> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.sprout(number,closure,"ProtoMeme");
	 ...
	 */
	@ReLogoBuilderGeneratedFor("picdna.relogo.ProtoMeme")
	public AgentSet<picdna.relogo.ProtoMeme> sproutProtoMemes(int number) {
		return sproutProtoMemes(number,null);
	}
